...
class HashkeyPerpetualUserStreamDataSourceUnitTests(IsolatedAsyncioWrapperTestCase):
    ...
    def setUp(self) -> None:
        ...
        self.auth = HashkeyPerpetualAuth(api_key="TEST_API_KEY", secret_key="TEST_SECRET", time_provider=self.mock_time_provider)
        ...
        self.data_source = HashkeyPerpetualUserStreamDataSource(
            auth=self.auth,
